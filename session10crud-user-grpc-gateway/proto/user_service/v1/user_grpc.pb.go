...
type UserServiceClient interface {
	...
	DeleteUser(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*MutationResponse, error)
}
...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*MutationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MutationResponse)
...
type UserServiceServer interface {
	...
	DeleteUser(context.Context, *DeleteRequest) (*MutationResponse, error)
...
func (UnimplementedUserServiceServer) DeleteUser(context.Context, *DeleteRequest) (*MutationResponse, error) {
